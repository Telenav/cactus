...
public final class Recipe implements Comparable<Recipe> {
    ...
    public static final Recipe POSSESSIVE_ADJECTIVE_NOUN = recipe(POSESSIVES, ADJECTIVES, VERBS);
    public static final Recipe POSSESSIVE_ADJECTIVE_NOUN_ADVERB = recipe(POSESSIVES, ADJECTIVES, VERBS, ADVERBS);
    ...
    public static final Recipe DOUBLE_ADJECTIVE_NOUN = recipe(ADJECTIVES, ADJECTIVES, NOUNS);
    public static final Recipe SENTENCE_LIKE = recipe(ADJECTIVES, NOUNS, ADVERBS, VERBS, PREPOSITIONS, POSESSIVES, NOUNS);
    public static final Recipe VERB_NOUN = recipe(VERBS, NOUNS);
    public static final Recipe VERB_ADJECTIVE_NOUN = recipe(VERBS, ADJECTIVES, LARGE_NOUNS);
    public static final Recipe TELENAV_DEFAULT = recipe(BUILD_NAME_ADJECTIVES, BUILD_NAME_NOUNS);

    private static final Recipe LARGE_NOUN_ADJECTIVE = recipe(LARGE_ADJECTIVES, LARGE_NOUNS);
    private static final Recipe LARGE_NOUN_VERB = recipe(LARGE_NOUNS, LARGE_VERBS);
    private static final Recipe LARGE_NOUN_DOUBLE_ADJECTIVE = recipe(LARGE_ADJECTIVES, LARGE_ADJECTIVES, LARGE_NOUNS);
     ...
     * @return A phrase
     */
    public String createPhrase(String delimiter, boolean shuffleBits, BoundValue... values) {
        if (values.length == 0) {
